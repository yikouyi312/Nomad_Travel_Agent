...
# Unified output directory - all artifacts stored under nomad/output
...
for _d in [CACHE_DIR, LLM_CACHE_DIR, VERIFICATION_DIR, CANDIDATES_DIR, PLANS_DIR, EVALUATIONS_DIR]:
